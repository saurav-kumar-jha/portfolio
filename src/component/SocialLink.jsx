...
const socialLinks = [
    {
        ...
        subText: "on LinkedIn",
        icon: Linkedin,
        url: "https://www.linkedin.com/in/saurav-kumar-jha/",
        color: "#0A66C2",
    ...
    },
    {
        ...
        subText: "@Sksaurav.1",
        icon: Instagram,
        url: "https://www.instagram.com/Sksaurav.1/?hl=id",
        color: "#E4405F",
    ...
    },
    {
        name: "GitHub",
        displayName: "Github",
        subText: "@saurav-kumar-jha",
        icon: Github,
        url: "https://github.com/saurav-kumar-jha",
        color: "#ffffff",
...
const SocialLinks = () => {
    ...
    return (
        <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
            <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2"><span className="inline-block w-8 h-1 bg-indigo-500 rounded-full"></span>Connect With Me</h3>

            <div className="flex flex-col gap-4">
                <a href={linkedIn.url} target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-between p-4 rounded-lg  bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500" >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[instagram,github].map((link) => (
                        <a key={link.name} href={link.url} target="_blank" rel="noopener noreferrer" className="group relative flex items-center gap-3 p-4 rounded-xl  bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500" >
