...
const WORDS = ["Computer Science Student", "Learner"];
const TECH_STACK = ["React Js", "Javascript", "Java","Springboot", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/saurav-kumar-jha" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/saurav-kumar-jha/" },
  { icon: Instagram, link: "https://www.instagram.com/Sksaurav.1/?hl=id" },
  { icon: SiLeetcode , link:"https://leetcode.com/u/SKJ1/"}
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden pt-4 px-3" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">Creating Innovative, Functional, and User-Friendly Websites for Digital Solutions.
                </p>
